 ...
 <div class="page-loader">
            ...
            <tbody>
                <?php foreach ($reservations as $reservation): ?>
                    <tr>
                        ...
                        <td class="actions">
                            <button  class="btn btn-glow-success btn-danger" onclick="confirmReservation(<?php echo $reservation['id_materiel']; ?>)">Supprimer </button>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    <script>
        ...
        function confirmReservation(id) {
            fetch('suppr_materiel.php?id=' + id)
