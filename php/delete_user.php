...
<body>
            ...
            <tbody>
                <?php foreach ($reservations as $reservation): ?>
                    <tr>
                        ...
                        <td class="actions">
                            <button  class="btn btn-glow-success btn-danger" onclick="confirmReservation(<?php echo $reservation['id_utilisateur']; ?>)">Supprimer</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    <script>
        ...
        function confirmReservation(id) {
            fetch('suppr_user.php?id=' + id)
                .then(response => response.json())
                .then(result => {
                    if (result.success) {
                        alert('utilisateur a été supprimé avec succés!');
                        location.reload(); // Recharger la page
                    } else {
                        alert('Erreur lors de la confirmation de la suppresion.');
                    }
                })
