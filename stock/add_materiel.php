                                ...
                                <form method="post" action="add.php" enctype="multipart/form-data">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <p style="font-size: 10px;color: rgb(255, 255, 255);"> </p>
                                    ...
                                    <div class="form-group">
                                        <label class="form-label">Qunantité</label>
                                        <input type="number" class="form-control" name="quantite" placeholder=""  required  >
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="form-row">
                                        ...
                                        <input type="file" class="form-control" name="image" placeholder="un image de la materiel"  required  >
                                        <div class="clearfix"></div>
                                    </div>
